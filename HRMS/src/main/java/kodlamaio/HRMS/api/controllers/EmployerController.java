...
@RestController
@RequestMapping(value = "/api/employeraccount")
public class EmployerController {
	...
	public ResponseEntity<?> add(@Valid @RequestBody EmployerAccount employerAccount) {
		return ResponseEntity.ok(this.employerService.add(employerAccount));
	}
